...
4. Launch app, Cmd+Shift+6 opens region capture
5. After selecting region, verify pendingCapture is set (log message: "Capture ready for annotation")
6. Verify annotation window opens (log message: "Loaded QuickCapture into annotation view")
7. Verify pendingCapture is cleared after window opens (no stale state)
8. Cmd+Shift+7 opens window capture, after capture annotation window opens
9. Annotation tools work (arrows, rectangles, text)
  </verify>
  <done>
